...
func (x *GetUsersRequest) GetCurPage() int64 {
	if x != nil {
		return x.CurPage
	}
	return 0
...
type GetUsersReply struct {
	...
	Users   []*UserDto `protobuf:"bytes,3,rep,name=users,proto3" json:"users,omitempty"`
...
func (x *GetUsersReply) GetUsers() []*UserDto {
	if x != nil {
		return x.Users
	}
	return nil
...
func (x *GetUsersReply) GetCurPage() int64 {
	if x != nil {
		return x.CurPage
	}
	return 0
...
func (x *GetUsersReply) GetTotal() int64 {
	if x != nil {
		return x.Total
	}
	return 0
...
func (x *RemoveUserReply) GetRes() bool {
	if x != nil {
		return x.Res
	}
	return false
...
func (x *AddUserRequest) GetUser() *UserVo {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *AddUserReply) GetRes() bool {
	if x != nil {
		return x.Res
	}
	return false
...
func (x *UpdateUserRequest) GetUser() *UserVo {
	if x != nil {
		return x.User
	}
	return nil
...
func (x *UpdateUserReply) GetRes() bool {
	if x != nil {
		return x.Res
	}
	return false
...
var file_api_user_v1_user_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x50, 0x0a, 0x06, 0x55, 0x73, 0x65, 0x72, 0x56, 0x6f, 0x12, 0x0e, 0x0a,
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x35, 0x0a, 0x07, 0x55, 0x73, 0x65, 0x72, 0x44, 0x74, 0x6f,
	...
	,
	...
	0x73, 0x65, 0x72, 0x2f, 0x7b, 0x69, 0x64, 0x7d, 0x12, 0x53, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x55,
	...
	,
	...
	0x72, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x64, 0x64, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x22, 0x10, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x0a, 0x3a, 0x01, 0x2a, 0x22, 0x05, 0x2f, 0x75,
	0x73, 0x65, 0x72, 0x12, 0x5c, 0x0a, 0x0a, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65,
	...
	0x72, 0x42, 0x24, 0x0a, 0x0b, 0x61, 0x70, 0x69, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x76, 0x31,
...
var file_api_user_v1_user_proto_goTypes = []interface{}{
	(*UserVo)(nil),            // 0: api.user.v1.UserVo
	(*UserDto)(nil),           // 1: api.user.v1.UserDto
	(*GetUserRequest)(nil),    // 2: api.user.v1.GetUserRequest
	(*GetUserReply)(nil),      // 3: api.user.v1.GetUserReply
	(*GetUsersRequest)(nil),   // 4: api.user.v1.GetUsersRequest
	(*GetUsersReply)(nil),     // 5: api.user.v1.GetUsersReply
	(*RemoveUserRequest)(nil), // 6: api.user.v1.RemoveUserRequest
	(*RemoveUserReply)(nil),   // 7: api.user.v1.RemoveUserReply
	(*AddUserRequest)(nil),    // 8: api.user.v1.AddUserRequest
	(*AddUserReply)(nil),      // 9: api.user.v1.AddUserReply
	(*UpdateUserRequest)(nil), // 10: api.user.v1.UpdateUserRequest
	(*UpdateUserReply)(nil),   // 11: api.user.v1.UpdateUserReply
}
var file_api_user_v1_user_proto_depIdxs = []int32{
	1,  // 0: api.user.v1.GetUserReply.user:type_name -> api.user.v1.UserDto
	1,  // 1: api.user.v1.GetUsersReply.users:type_name -> api.user.v1.UserDto
	0,  // 2: api.user.v1.AddUserRequest.user:type_name -> api.user.v1.UserVo
	0,  // 3: api.user.v1.UpdateUserRequest.user:type_name -> api.user.v1.UserVo
	2,  // 4: api.user.v1.User.GetUser:input_type -> api.user.v1.GetUserRequest
	4,  // 5: api.user.v1.User.GetUsers:input_type -> api.user.v1.GetUsersRequest
	6,  // 6: api.user.v1.User.RemoveUser:input_type -> api.user.v1.RemoveUserRequest
	8,  // 7: api.user.v1.User.SaveUser:input_type -> api.user.v1.AddUserRequest
	10, // 8: api.user.v1.User.UpdateUser:input_type -> api.user.v1.UpdateUserRequest
	3,  // 9: api.user.v1.User.GetUser:output_type -> api.user.v1.GetUserReply
	5,  // 10: api.user.v1.User.GetUsers:output_type -> api.user.v1.GetUsersReply
	7,  // 11: api.user.v1.User.RemoveUser:output_type -> api.user.v1.RemoveUserReply
	9,  // 12: api.user.v1.User.SaveUser:output_type -> api.user.v1.AddUserReply
	11, // 13: api.user.v1.User.UpdateUser:output_type -> api.user.v1.UpdateUserReply
